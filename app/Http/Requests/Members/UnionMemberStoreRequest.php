...
class UnionMemberStoreRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'name.regex' => 'El nombre no debe contener números ni caracteres inválidos.',
            'email.required' => 'El correo electrónico es obligatorio.',
            'email.email' => 'Ingresa un correo electrónico válido.',
            'gender.required' => 'Selecciona una opción de sexo / género.',
            'gender.in' => 'Selecciona una opción válida de sexo / género.',
