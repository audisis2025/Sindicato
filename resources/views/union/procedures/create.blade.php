...
<x-layouts.app :title="__('Crear nuevo trámite')">
        ...
        <form action="{{ route('union.procedures.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" min="1" name="estimated_days" required
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="steps[IDX][step_description]" rows="2" maxlength="2000"
                        class="w-full border border-[#D9D9D9] rounded-lg px-4 py-2" placeholder="Describe este paso..."></textarea>
                </div>

                <div>
                    <label class="block font-semibold text-[#272800] mb-1">¿Requiere documento?</label>
                    <select name="steps[IDX][requires_file]" required
                        class="w-full border border-[#D9D9D9] rounded-lg px-4 py-2 sel-requires">
    ...
    <script>
        ...
        addPaso();
        addPaso();
        const form = document.querySelector('form[action="{{ route('union.procedures.store') }}"]');
        ...
        form.addEventListener('submit', (e) => {
            ...
            if (total < 1) {
                ...
                Swal.fire({
                    icon: 'warning',
                    title: 'Faltan pasos',
                    text: 'Debes agregar al menos un paso para guardar el trámite.',
