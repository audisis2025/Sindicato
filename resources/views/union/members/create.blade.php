{{-- 
* Nombre de la vista           : members-create.blade.php
...
* Descripción del mantenimiento: Homologación con create de usuarios, estandarización Flux UI y colores PRO-Laravel V3.4.
...
<x-layouts.app :title="__('Alta de trabajador')">
    ...
    <div class="w-full flex flex-col items-center justify-center min-h-[80vh] bg-white text-black p-6">
        ...
        <form 
            action="{{ route('union.members.store') }}" 
            method="POST"
